...
create_excel_sheet <- function(wb, .data, sheet_name, hfd_ids, hfd_titles,
  ...
  headerStyle <- create_custom_style(
    fontColour = "red", fgFill = "khaki1", textDecoration = "bold",
    border = "TopBottomLeftRight", borderColour = "black"
  )
  subHeaderStyle <- create_custom_style(
    fontColour = "white", fgFill = "darkcyan",
    textDecoration = "bold", border = "TopBottomLeftRight", borderColour = "white"
  )
  contentStyle <- create_custom_style(
    fgFill = "gray", border = "TopBottomLeftRight", borderColour = "white",
    halign = NULL
  )
