---
title: "Consistency Checks for `r params$country` --- Countdown Analysis"
...
## Comparison between ANC1 and Penta 1
...
```{r, results='asis'}
print_notes(cache, 'consistency_checks', 'ANC1 and Penta1')
```
...
## Comparison between Penta 1 and Penta 3
...
## Comparison between OPV 1 and OPV 3
...
```{r, results='asis'}
print_notes(cache, 'consistency_checks', 'OPV1 and OPV3')
```
