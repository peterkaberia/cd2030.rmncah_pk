...
plot(adjustments,
     indicator = 'bcg',
     title = 'Comparison of number of BCG vaccination before and after adjustments for completness and outliers') +
  cd_report_theme()
```
...
plot(adjustments,
     indicator = 'measles1',
     title = 'Comparison of number of measles vaccination before and after adjustments for completness and outliers') +
  cd_report_theme()
```
...
```{r, fig.cap='Pentavalent 3 coverage by wealth, recent surveys'}
...
```{r, fig.cap='Penta3 coverage by level of education of the mother, recent surveys'}
...
```{r, fig.cap='Penta3 coverage by place of residence, recent surveys'}
...
```{r, fig.cap='Measles 1 coverage by wealth, recent surveys'}
...
```{r, fig.cap='Measles 1coverage by level of education of the mother, recent surveys'}
...
```{r, fig.cap='Measles 1 coverage by place of residence, recent surveys'}
